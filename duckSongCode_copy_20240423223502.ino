...
void interactionFour() {
  ...
  if (buttonPushCounter == 3 && actionVal == 4 && digitalRead(duckStand) == HIGH && digitalRead(man) == HIGH) {
    myservo.write(180);
    soundPlay = true;
    actionVal = 5;
...
void stopMusicDuck() {
  if (digitalRead(duck) == LOW && digitalRead(man) == HIGH && actionVal == 5) {
    soundPlay = false;
  }
}
...
void stopMusicMan() {
  if (actionVal == 6 && digitalRead(duck) == HIGH && digitalRead(man) == LOW) {
    soundPlay = false;
  }
}
...
void interactionSix() {
    //player presses button
  if (buttonPushCounter == 4 && actionVal == 6 && digitalRead(duck) == HIGH && digitalRead(man) == HIGH) {   
    //led start button turns off
    //led stand turns on
    //sound effect plays
    //action value 7
...
void interactionEight() {
  ...
  if (buttonPushCounter == 5 && actionVal == 8 && digitalRead(duckStand) == HIGH && digitalRead(man) == HIGH) {
...
void interactionNine() {
  ...
  if (actionVal == 9 && digitalRead(duck) == HIGH && digitalRead(man) == HIGH) {
    //led store turns off
...
void interactionTen() {
  ...
  if (actionVal == 10 && digitalRead(duck) == HIGH && digitalRead(man) == HIGH && digitalRead(storeGrapes) == HIGH) {
    //sound effect plays
    //action value updated
    soundPlay = true;
    actionVal = 11;
